...
if not exist "C:\Windows\Temp\windows.iso" (
    powershell -Command "(New-Object System.Net.WebClient).DownloadFile('http://softwareupdate.vmware.com/cds/vmw-desktop/fusion/8.0.0/2985594/packages/com.vmware.fusion.tools.windows.zip.tar', 'C:\Windows\Temp\com.vmware.fusion.tools.windows.zip.tar')" <NUL
    cmd /c ""C:\Program Files\7-Zip\7z.exe" x C:\Windows\Temp\com.vmware.fusion.tools.windows.zip.tar -oC:\Windows\Temp"
    cmd /c ""C:\Program Files\7-Zip\7z.exe" x C:\Windows\Temp\com.vmware.fusion.tools.windows.zip -oC:\Windows\Temp"
    move /Y "C:\Windows\Temp\payload\windows.iso" C:\Windows\Temp
...
cmd /c certutil -addstore -f "TrustedPublisher" E:\cert\oracle-vbox.cer
